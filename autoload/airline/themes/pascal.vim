...
function! airline#themes#pascal#refresh()
  let s:colors = {
  ...
  \ "cursor_grey": { "gui": "#38363a", "cterm": "236", "cterm16": "0" },
  ...
  " # Palette
  let g:airline#themes#pascal#palette = {}

  " ## Accents
  let g:airline#themes#pascal#palette.accents = {
  ...
  let g:airline#themes#pascal#palette.normal = airline#themes#generate_color_map(s:N1, s:N2, s:N3)

  let group = airline#themes#get_highlight('vimCommand')
  let g:airline#themes#pascal#palette.normal_modified = {
  ...
  let g:airline#themes#pascal#palette.insert = airline#themes#generate_color_map(s:I1, s:I2, s:I3)
  let g:airline#themes#pascal#palette.insert_modified = g:airline#themes#pascal#palette.normal_modified
  ...
  let g:airline#themes#pascal#palette.replace = airline#themes#generate_color_map(s:R1, s:R2, s:R3)
  let g:airline#themes#pascal#palette.replace_modified = g:airline#themes#pascal#palette.normal_modified
  ...
  let g:airline#themes#pascal#palette.visual = airline#themes#generate_color_map(s:V1, s:V2, s:V3)
  let g:airline#themes#pascal#palette.visual_modified = g:airline#themes#pascal#palette.normal_modified
  ...
  let s:IA3 = s:N2
  let g:airline#themes#pascal#palette.inactive = airline#themes#generate_color_map(s:IA1, s:IA2, s:IA3)
  let g:airline#themes#pascal#palette.inactive_modified = {
        \ 'airline_c': [ group[0], '', group[2], '', '' ]
        \ }

  " ## Warnings
  let s:WI = [ s:colors.cursor_grey.gui, s:colors.yellow.gui, s:term_cursor_grey, s:term_yellow ]
  let g:airline#themes#pascal#palette.normal.airline_warning = [
       \ s:WI[0], s:WI[1], s:WI[2], s:WI[3]
       \ ]

  let g:airline#themes#pascal#palette.normal_modified.airline_warning =
      \ g:airline#themes#pascal#palette.normal.airline_warning

  let g:airline#themes#pascal#palette.insert.airline_warning =
      \ g:airline#themes#pascal#palette.normal.airline_warning

  let g:airline#themes#pascal#palette.insert_modified.airline_warning =
      \ g:airline#themes#pascal#palette.normal.airline_warning

  let g:airline#themes#pascal#palette.visual.airline_warning =
      \ g:airline#themes#pascal#palette.normal.airline_warning

  let g:airline#themes#pascal#palette.visual_modified.airline_warning =
      \ g:airline#themes#pascal#palette.normal.airline_warning

  let g:airline#themes#pascal#palette.replace.airline_warning =
      \ g:airline#themes#pascal#palette.normal.airline_warning

  let g:airline#themes#pascal#palette.replace_modified.airline_warning =
      \ g:airline#themes#pascal#palette.normal.airline_warning

  " ## Errors
  let s:ER = [ s:colors.cursor_grey.gui, s:colors.red.gui, s:term_cursor_grey, s:term_red ]
  let g:airline#themes#pascal#palette.normal.airline_error = [
       \ s:ER[0], s:ER[1], s:ER[2], s:ER[3]
       \ ]

  let g:airline#themes#pascal#palette.normal_modified.airline_error =
      \ g:airline#themes#pascal#palette.normal.airline_error

  let g:airline#themes#pascal#palette.insert.airline_error =
      \ g:airline#themes#pascal#palette.normal.airline_error

  let g:airline#themes#pascal#palette.insert_modified.airline_error =
      \ g:airline#themes#pascal#palette.normal.airline_error

  let g:airline#themes#pascal#palette.visual.airline_error =
      \ g:airline#themes#pascal#palette.normal.airline_error

  let g:airline#themes#pascal#palette.visual_modified.airline_error =
      \ g:airline#themes#pascal#palette.normal.airline_error

  let g:airline#themes#pascal#palette.replace.airline_error =
      \ g:airline#themes#pascal#palette.normal.airline_error

  let g:airline#themes#pascal#palette.replace_modified.airline_error =
      \ g:airline#themes#pascal#palette.normal.airline_error

endfunction

call airline#themes#pascal#refresh()
